...
class MainFrame$2
	...
	public void actionPerformed(ActionEvent e) {
		val$chooser.setSelectedFile(new File(MainFrame.access$100(MainFrame.this).getText()));
		int i = val$chooser.showOpenDialog(MainFrame.this);
		if (i == 0) {
			MainFrame.access$100(MainFrame.this).setText(val$chooser.getSelectedFile().getAbsolutePath());
		}
	}
