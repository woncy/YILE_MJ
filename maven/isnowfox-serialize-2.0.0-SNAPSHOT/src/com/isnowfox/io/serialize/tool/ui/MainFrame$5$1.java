...
class MainFrame$5$1 extends SwingWorker {

	final MainFrame$5 this$1;

	protected Void doInBackground() throws Exception {
		MessageBuilder b = new MessageBuilder(c, new LogProxy() {

			final MainFrame._cls5._cls1 this$2;
			...
			public transient void info(String str, Object args[]) {
			 ...
			 {
				this.this$2 = MainFrame._cls5._cls1.this;
				super();
			}
		});
		b.buildClient();
