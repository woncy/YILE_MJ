...
class MainFrame$4$1$1
	implements LogProxy {

	final MainFrame$4$1 this$2;
	...
	MainFrame$4$1$1() {
		this.this$2 = MainFrame$4$1.this;
		super();
	}

	// Unreferenced inner class com/isnowfox/io/serialize/tool/ui/MainFrame$4

/* anonymous class */
	class MainFrame._cls4
		...
		public void actionPerformed(ActionEvent e) {
			...
			updateCfg();
			(new MainFrame._cls4._cls1()).execute();
		}
	...
	// Unreferenced inner class com/isnowfox/io/serialize/tool/ui/MainFrame$4$1

/* anonymous class */
	class MainFrame._cls4._cls1 extends SwingWorker {

		final MainFrame._cls4 this$1;

		protected Void doInBackground() throws Exception {
			MessageBuilder b = new MessageBuilder(c, new MainFrame._cls4._cls1._cls1());
			b.buildServer();
			return null;
		}
		...
		protected volatile Object doInBackground() throws Exception {
			return doInBackground();
			 ...
			 {
				this.this$1 = MainFrame._cls4.this;
				super();
			}
	}
