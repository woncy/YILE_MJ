...
class MainFrame$1
	...
	public void actionPerformed(ActionEvent e) {
		val$chooser.setSelectedFile(new File(MainFrame.access$000(MainFrame.this).getText()));
		int i = val$chooser.showOpenDialog(MainFrame.this);
		if (i == 0) {
			MainFrame.access$000(MainFrame.this).setText(val$chooser.getSelectedFile().getAbsolutePath());
		}
	}
