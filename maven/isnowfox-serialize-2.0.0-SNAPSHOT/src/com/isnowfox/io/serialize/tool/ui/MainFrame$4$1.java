...
class MainFrame$4$1 extends SwingWorker {

	final MainFrame$4 this$1;

	protected Void doInBackground() throws Exception {
		MessageBuilder b = new MessageBuilder(c, new LogProxy() {

			final MainFrame._cls4._cls1 this$2;
			...
			public transient void info(String str, Object args[]) {
			 ...
			 {
				this.this$2 = MainFrame._cls4._cls1.this;
				super();
			}
		});
		b.buildServer();
