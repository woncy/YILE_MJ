...
mvn install:install-file	-Dfile=alipay-sdk.jar -DgroupId=com.alipay -DartifactId=sdk-java -Dversion=20170616 -Dpackaging=jar 
mvn install:install-file     -Dfile=alipay-sdk-java20170615110434.jar    -DgroupId=com.alipay     -DartifactId=sdk-java    -Dversion=20170615110434 -Dpackaging=jar
