...
// Source File Name:   CacheDaoImplCreate.java
...
public class CacheDaoImplCreate {
	...
	private static final Logger log = LoggerFactory.getLogger(org/forkjoin/jdbckit/mysql/CacheDaoImplCreate);

	public CacheDaoImplCreate() {
	}
	...
	public static void create(List tl, Config config, String objectPack, String daoPack, String daoImplPack) throws Exception {
		...
		do {
			...
			File f = new File(dir, (new StringBuilder()).append(ta.getClassName()).append("CacheDao.java").toString());
			...
			try {
				...
				HttlUtils.render("/org/forkjoin/jdbckit/mysql/template/cacheDaoImpl.httl", context, out);
			}
