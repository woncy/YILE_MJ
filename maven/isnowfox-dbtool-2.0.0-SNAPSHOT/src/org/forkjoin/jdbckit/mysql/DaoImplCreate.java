...
// Source File Name:   DaoImplCreate.java
...
public class DaoImplCreate {
	...
	private static final Logger log = LoggerFactory.getLogger(org/forkjoin/jdbckit/mysql/DaoImplCreate);

	public DaoImplCreate() {
	}
	...
	public static void create(List tl, Config config, String objectPack, String daoPack, String daoImplPack) throws Exception {
		...
		do {
			...
			File f = new File(dir, (new StringBuilder()).append(ta.getClassName()).append("Dao.java").toString());
