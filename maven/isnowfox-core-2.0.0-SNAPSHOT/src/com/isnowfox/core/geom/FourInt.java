...
public class FourInt {
	...
	public String toString() {
		return (new StringBuilder()).append("FourInt{top=").append(top).append(", right=").append(right).append(", bottom=").append(bottom).append(", left=").append(left).append('}').toString();
	}
