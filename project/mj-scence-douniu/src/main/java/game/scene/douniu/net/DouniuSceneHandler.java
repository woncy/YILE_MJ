...
public class DouniuSceneHandler implements PxMsgHandler<Gateway> {
    private static final Logger log = LoggerFactory.getLogger(DouniuSceneHandler.class);
