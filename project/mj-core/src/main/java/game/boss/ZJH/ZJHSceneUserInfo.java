package game.boss.ZJH;

import io.netty.buffer.ByteBuf;
import io.netty.channel.ChannelHandlerContext;

public class ZJHSceneUserInfo {
	 private short sessionId;
	    private int gatewayId;
	    private int userId;

	    public ZJHSceneUserInfo(short sessionId, int gatewayId, int userId) {
	        this.sessionId = sessionId;
	        this.gatewayId = gatewayId;
	        this.userId = userId;
	    }

	    public ZJHSceneUserInfo() {
	    }
