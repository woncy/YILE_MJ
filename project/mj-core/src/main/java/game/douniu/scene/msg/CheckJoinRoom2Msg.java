...
public class CheckJoinRoom2Msg  extends AbstractSessionPxMsg{
	 public static final int ID = 9;
	  ...
	  /*  private int user0;
	    ...
	    private UserInfo controlUser;
	    private Map<String, String> options = new TreeMap<>();

	    public CheckJoinRoom2Msg() {
	        super(ID);
	    }
	@Override
...
//	        /**房间的check-id,进入id,可以重复,但是不允许同时活跃状态的id 相同*/
	...
	public UserInfo getControlUser() {
		return controlUser;
	}
	public void setControlUser(UserInfo controlUser) {
	...
	public String toString() {
		return "CheckJoinDouniuRoomMsg [sceneId=" + sceneId + ", roomId="
				...
				+ ", joinUserId=" + joinUserId + ", UserInfos="
				+ UserInfos + ", options=" + options + "]";
	}
