...
public class CheckJoinDouniuRoomResult extends AbstractSessionPxMsg {
    public static final int ID = CheckJoinDouniuRoomMsg.ID+1;
    ...
    public CheckJoinDouniuRoomResult() {
        super(ID);
    }
