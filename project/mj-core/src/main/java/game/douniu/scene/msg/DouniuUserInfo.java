...
public class DouniuUserInfo extends AbstractSessionPxMsg {
	 	private int userId;
	...
	public String toString() {
		return "DouniuUserInfo [userId=" + userId + ", locationIndex=" + locationIndex + ", sessionId=" + sessionId
				+ ", gatewayId=" + gatewayId + ", userName=" + userName + ", avatar=" + avatar + ", sex=" + sex
				+ ", gold=" + gold + ", ip=" + ip + ", longitude=" + longitude + ", latitude=" + latitude + "]";
	}
