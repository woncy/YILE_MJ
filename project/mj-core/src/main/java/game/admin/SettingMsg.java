...
public class SettingMsg extends AbstractSessionPxMsg {
	...
	public boolean equals(Object obj) {
		if(obj instanceof SettingMsg){
			SettingMsg msg = (SettingMsg) obj;
			return this.agreement.equals(msg.getAgreement())
					&&this.initGold==msg.getInitGold()
					&&this.notice.equals(msg.getNotice())
					&& this.payInfo.equals(msg.getPayInfo())
					&& this.radio.equals(msg.getRadio());
		}
		return false;
	}
