...
public class CheckOffLineZJHRoom extends AbstractSessionPxMsg{
    ...
    public CheckOffLineZJHRoom() {
        super(ID);
    }
	public CheckOffLineZJHRoom(int id) {
		super(id);
	}
	...
	public String toString() {
		return "CheckOffLineZJHRoom [sceneId=" + sceneId + ", roomId=" + roomId + ", userId=" + userId
