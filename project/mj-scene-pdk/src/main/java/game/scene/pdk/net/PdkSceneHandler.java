...
public class PdkSceneHandler implements PxMsgHandler<Gateway> {
    private static final Logger log = LoggerFactory.getLogger(PdkSceneHandler.class);
