...
public class PokerDaoBuilder {
    private static final Logger log = LoggerFactory.getLogger(PokerDaoBuilder.class);
    ...
    public static void main(String[] args) {
        try {
            ...
            config.setPack("game.boss.poker.dao");
            IocFactory ioc = new SpringIocFactory("/poker/pokerBuilderContext.xml");
