...
public class RoomResultDO extends EntityObject<RoomResultDO, RoomResultDO.Key>{
	...
	public void setWinUserId(Integer winUserId) {
		this.winUserId = winUserId;
		changeProperty("winUserId",winUserId);
	}
	...
	public static final class Table extends TableInfo<RoomResultDO ,Key>{
		...
		public static final String WINUSERID = "winUserId";
		...
		private Table(){
			...
			super.initProperty("winUserId", "winUserId", Integer.class, new TypeReference<Integer>() {});
		}
		...
		public int setPreparedStatement(RoomResultDO t, PreparedStatement ps, int i, boolean isSetUnique) throws SQLException {
			...
			Object winUserIdPtr;
			winUserIdPtr = t.getWinUserId();

			ps.setObject(i++, winUserIdPtr);
			return i;
		}
		...
		@Override public String getInsertSql(){
			return "INSERT INTO `room_result` (`room_id`,`room_check_id`,`scene_id`,`create_date`,`user0`,`user1`,`user2`,`user3`,`userName0`,`userName1`,`userName2`,`userName3`,`score0`,`score1`,`score2`,`score3`,`hu_pai`,`hu_pai_index`,`zhuang_index`,`is_zi_mo`,`hui_er`,`gang_shang_hua`,`last_pai`,`fang_pao_index`,`left`,`user_pai_infos`,`winUserId`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		}

		@Override public String getReplaceSql(){
        	return "REPLACE INTO `room_result` (`id`,`room_id`,`room_check_id`,`scene_id`,`create_date`,`user0`,`user1`,`user2`,`user3`,`userName0`,`userName1`,`userName2`,`userName3`,`score0`,`score1`,`score2`,`score3`,`hu_pai`,`hu_pai_index`,`zhuang_index`,`is_zi_mo`,`hui_er`,`gang_shang_hua`,`last_pai`,`fang_pao_index`,`left`,`user_pai_infos`,`winUserId`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        }
		...
		@Override public String getUpdateSql(){
			return "UPDATE `room_result` SET `room_id`=?,`room_check_id`=?,`scene_id`=?,`create_date`=?,`user0`=?,`user1`=?,`user2`=?,`user3`=?,`userName0`=?,`userName1`=?,`userName2`=?,`userName3`=?,`score0`=?,`score1`=?,`score2`=?,`score3`=?,`hu_pai`=?,`hu_pai_index`=?,`zhuang_index`=?,`is_zi_mo`=?,`hui_er`=?,`gang_shang_hua`=?,`last_pai`=?,`fang_pao_index`=?,`left`=?,`user_pai_infos`=?,`winUserId`=? WHERE `id`=?";
		}
		...
		@Override public RowMapper<RoomResultDO> getRowMapper(){
			return new RowMapper<RoomResultDO>() {
				...
				public RoomResultDO mapRow(ResultSet rs, int rowNum) throws SQLException {
					...
					o.winUserId = rs.getInt("winUserId");
					return o;
				}
			};
		}
			...
			return new RowMapper<C>() {
				...
				public C mapRow(ResultSet rs, int rowNum) throws SQLException {
					...
					try{
						...
						o.setWinUserId(rs.getInt("winUserId"));
                        return o;
