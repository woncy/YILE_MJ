...
public class TbPkRoomUserDO extends EntityObject<TbPkRoomUserDO, TbPkRoomUserDO.Key>{
	...
	public TbPkRoomUserDO(Integer roomId,Integer endScore,Integer userId,Integer locationIndex,Integer winCount,java.util.Date joinDate) {
		this.roomId = roomId;
	...
	public void setJoinDate(java.util.Date joinDate) {
		this.joinDate = joinDate;
		changeProperty("joinDate",joinDate);
	}
	...
	@Override
	public String toString() {
		return "TbPkRoomUser[id:"+ id+",roomId:"+ roomId+",endScore:"+ endScore+",userId:"+ userId+",locationIndex:"+ locationIndex+",winCount:"+ winCount+",joinDate:"+ joinDate+ "]";
	}
	...
	public static final class Table extends TableInfo<TbPkRoomUserDO ,Key>{
		...
		private Table(){
			...
			super.initProperty("joinDate", "joinDate", java.util.Date.class, new TypeReference<java.util.Date>() {});
		}
		...
		public int setPreparedStatement(TbPkRoomUserDO t, PreparedStatement ps, int i, boolean isSetUnique) throws SQLException {
			...
			Object joinDatePtr;
			joinDatePtr = t.getJoinDate();

			ps.setObject(i++, joinDatePtr);
			return i;
		}
		...
		@Override public String getInsertSql(){
			return "INSERT INTO `tb_pk_room_user` (`room_id`,`end_score`,`user_id`,`locationIndex`,`winCount`,`joinDate`) VALUES (?,?,?,?,?,?)";
		}

		@Override public String getReplaceSql(){
        	return "REPLACE INTO `tb_pk_room_user` (`id`,`room_id`,`end_score`,`user_id`,`locationIndex`,`winCount`,`joinDate`) VALUES (?,?,?,?,?,?,?)";
        }
		...
		@Override public String getUpdateSql(){
			return "UPDATE `tb_pk_room_user` SET `room_id`=?,`end_score`=?,`user_id`=?,`locationIndex`=?,`winCount`=?,`joinDate`=? WHERE `id`=?";
		}
		...
		@Override public RowMapper<TbPkRoomUserDO> getRowMapper(){
			return new RowMapper<TbPkRoomUserDO>() {
				...
				public TbPkRoomUserDO mapRow(ResultSet rs, int rowNum) throws SQLException {
					...
					o.joinDate = rs.getTimestamp("joinDate");
					return o;
				}
			};
		}
			...
			return new RowMapper<C>() {
				...
				public C mapRow(ResultSet rs, int rowNum) throws SQLException {
					...
					try{
						...
						o.setJoinDate(rs.getTimestamp("joinDate"));
                        return o;
