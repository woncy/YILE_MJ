...
public final class MessageFactoryImpi extends AbstractMessageFactory {
	...
	protected FastConstructor[][] init() {
		...
		array[1][38] = FastClass.create(mj.net.message.game.AudioMsg.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
...
//		array[7][40] = FastClass.create(mj.net.message.login.SubmitIDCard.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
	...
	private void initDouniuMessage(FastConstructor[][] array) {
		array[2] = new FastConstructor[52];
		// 创建房间
//		array[2][0] = FastClass.create(CreateDouniuRoom.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		// 创建房间结果
		array[2][1] = FastClass.create(mj.net.message.login.douniu.CreateDouniuRoomResult.class)
				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
		// 加入房间
		array[2][2] = FastClass.create(mj.net.message.login.douniu.JoinDouniuRoom.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][3] = FastClass.create(mj.net.message.login.douniu.JoinRoomResult.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][4] = FastClass.create(mj.net.message.login.douniu.JoinDouniuRoomReadyDone.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][5] = FastClass.create(mj.net.message.game.douniu.DNGameRoomInfo.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][6] = FastClass.create(mj.net.message.game.douniu.DNChapterInfo.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][7] = FastClass.create(mj.net.message.game.douniu.SeatUserInfo.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][8] = FastClass.create(mj.net.message.game.douniu.DNGameStart.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][9] = FastClass.create(mj.net.message.game.douniu.DNGameReady.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][10] = FastClass.create(mj.net.message.game.douniu.DNQiangZhuang.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][11] = FastClass.create(mj.net.message.game.douniu.DNGameZhuang.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][12] = FastClass.create(mj.net.message.game.douniu.DNKaiPai.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][13] = FastClass.create(mj.net.message.game.douniu.DNChapterPKResult.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][14] = FastClass.create(mj.net.message.game.douniu.DNShowXiaZhu.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][15] = FastClass.create(mj.net.message.game.douniu.DNXiaZhu.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][16] = FastClass.create(mj.net.message.game.douniu.RoomResult.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][17] = FastClass.create(mj.net.message.game.douniu.DNGameExitUser.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][18] = FastClass.create(mj.net.message.game.douniu.DNDismissVote.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		array[2][19] = FastClass.create(mj.net.message.game.douniu.DNDismissUserResult.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
		// 加入房间结果
		//array[2][3] = FastClass.create(mj.net.message.login.douniu.JoinRoomResult.class).getConstructor(Constants.EMPTY_CLASS_ARRAY);
//		// 加入房间准备
//		array[2][4] = FastClass.create(mj.net.message.login.douniu.JoinDouniuRoomReady.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
//		// 加入房间准备结果
		
		// 退出房间
//		array[2][6] = FastClass.create(mj.net.message.login.douniu.ExitDouniuRoom.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
		// 退出房间结果
//		array[2][7] = FastClass.create(mj.net.message.login.douniu.ExitDouniuRoomResult.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
		// 斗牛开始游戏消息
		
//		array[2][8] = FastClass.create(mj.net.message.game.douniu.DouniuStartGame.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
		// 斗牛开始游戏消息结果
//		array[2][9] = FastClass.create(mj.net.message.game.douniu.DouniuStartGameRet.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
		// 发牌
//		array[2][10] = FastClass.create(mj.net.message.game.douniu.DouniuFaPai.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
		// 发牌 结果
//		array[2][11] = FastClass.create(mj.net.message.game.douniu.DouniuFaPaiRet.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
		// 下注
//		array[2][12] = FastClass.create(mj.net.message.game.douniu.DouniuShu.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
		// 下注 结果
//		array[2][13] = FastClass.create(mj.net.message.game.douniu.DouniuZhuRet.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
		// 斗牛发送服务器下注的倍数
//				array[5][26] = FastClass.create(mj.net.message.game.douniu.DouniuSendMsgShu.class)
//						.getConstructor(Constants.EMPTY_CLASS_ARRAY);
		// 比牌
//		array[2][14] = FastClass.create(mj.net.message.game.douniu.DouniuBiCard.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
		// 比牌 结果
//		array[2][15] = FastClass.create(mj.net.message.game.douniu.DouniuBiCardRet.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
		// 比牌渲染
//		array[2][16] = FastClass.create(mj.net.message.game.douniu.DouniuBiCardOther.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
//		// 比牌渲染 结果
//		array[2][17] = FastClass.create(mj.net.message.game.douniu.DouniuBiCardOtherRet.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
		// 下家说话
		
		//解散房间投票
//		array[2][43] = FastClass.create(mj.net.message.game.douniu.DouniuVoteDelSelectRet.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
//		array[2][44] = FastClass.create(mj.net.message.game.douniu.DouniuUserOffline.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
		//删除房间
//		array[2][45] = FastClass.create(mj.net.message.login.douniu.DeDouniuRoomResult.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
//		array[2][46] = FastClass.create(mj.net.message.login.douniu.DeDouniuRoom.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
	   //战绩查询
//		array[2][47] = FastClass.create(mj.net.message.login.douniu.DouniuRoomHistory.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
//		array[2][48] = FastClass.create(mj.net.message.login.douniu.DouniuRoomHistoryList.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
//		array[2][49] = FastClass.create(mj.net.message.login.douniu.DouniuRoomHistoryListRet.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
	   //聊天
//		array[2][50] = FastClass.create(mj.net.message.game.douniu.DouniuChat.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
//		array[2][51] = FastClass.create(mj.net.message.game.douniu.DouniuChatRet.class)
//				.getConstructor(Constants.EMPTY_CLASS_ARRAY);
	}
