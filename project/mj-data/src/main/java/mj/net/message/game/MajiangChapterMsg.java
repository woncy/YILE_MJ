...
public class MajiangChapterMsg extends AbstractMessage{
	 ...
	 */
	private boolean currentPaoFlage;
	...
	public void decode(Input in)  throws IOException, ProtocolException {
		...
		currentPaoFlage = in.readBoolean();
	}
	...
	public void encode(Output out)  throws IOException, ProtocolException {
		...
		out.writeBoolean(currentPaoFlage);
	}
	...
	public boolean isCurrentPaoFlage() {
		return currentPaoFlage;
	}

	public void setCurrentPaoFlage(boolean currentPaoFlage) {
		this.currentPaoFlage = currentPaoFlage;
	}
