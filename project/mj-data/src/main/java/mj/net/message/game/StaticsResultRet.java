...
//		chatContent = in.readString();
	...
	public String toString() {
		...
		return "StaticsResultRet [locationIndex0=" + locationIndex0 + 
				",zimo0="+zimo0+",fangpao0="+fangpao0+",jiepao0="+jiepao0+",angang0="+angang0+",minggang0="+minggang0+",score0="+score0+
				
				",locationIndex1=" + locationIndex1 + 
				",zimo1="+zimo1+",fangpao1="+fangpao1+",jiepao1="+jiepao1+",angang1="+angang1+",minggang1="+minggang1+",score1="+score1+
				
				",locationIndex2=" + locationIndex2 + 
				",zimo2="+zimo2+",fangpao2="+fangpao2+",jiepao2="+jiepao2+",angang2="+angang2+",minggang2="+minggang2+",score2="+score2+
				
				",locationIndex3=" + locationIndex3 + 
				",zimo3="+zimo3+",fangpao3="+fangpao3+",jiepao3="+jiepao3+",angang3="+angang3+",minggang3="+minggang3+",score3="+score3+
