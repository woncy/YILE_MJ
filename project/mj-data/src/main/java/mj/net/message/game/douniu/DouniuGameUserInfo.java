 ...
 */
public class DouniuGameUserInfo extends AbstractMessage{
	...
	public DouniuGameUserInfo(String userName, String avatar, int sex, int gold, int score, int locationIndex, int userId, boolean online, String ip, String user0Distance, String user1Distance, String user2Distance, String user3Distance, String user4Distance, String user5Distance){
	...
	public void decode(Input in)  throws IOException, ProtocolException {
		...
		user4Distance = in.readString();
		user5Distance = in.readString();
	}
	...
	public void encode(Output out)  throws IOException, ProtocolException {
		...
		out.writeString(getUser4Distance());
		out.writeString(getUser5Distance());
	}
	...
	public String toString() {
		return "DouniuGameUserInfo [userName=" + userName + ", avatar="
				...
				+ user4Distance + ", user5Distance=" + user5Distance + "]";
	}
