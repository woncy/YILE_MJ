...
public enum JiaFanType {
    QUEYILU_HU("缺一路", 1) {
        ...
        public int compute(FanResult fanResult, ChapterEndResult chapterResult, UserPlace userPlace, UserPaiInfo userPaiInfo) {
            return userPaiInfo.getEndType() == 1  ? 1 : 0;
        }
    },
    ...
    QUEERLU_HU("缺二路", 3) {
        @Override
        public int compute(FanResult fanResult, ChapterEndResult chapterResult, UserPlace userPlace, UserPaiInfo userPaiInfo) {
            return userPaiInfo.getEndType() == 2 ? 1 : 0;
        }
    },
    ...
    QUESANLU_HU("缺三路", 5) {
        @Override
        public int compute(FanResult fanResult, ChapterEndResult chapterResult, UserPlace userPlace, UserPaiInfo userPaiInfo) {
            return userPaiInfo.getEndType() == 3 ? 1 : 0;
        }
    },
    QINGYISE_HU("风字清一色", 10) {
        @Override
        public int compute(FanResult fanResult, ChapterEndResult chapterResult, UserPlace userPlace, UserPaiInfo userPaiInfo) {
            return userPaiInfo.getEndType() == 4 ? 1 : 0;
        }
    },
    JIA_AN_GANG("加暗杠", 4) {
      @Override
...
//        @Override
//        public int compute(FanResult fanResult, ChapterEndResult chapterResult, UserPlace userPlace, UserPaiInfo userPaiInfo) {
//            return userPaiInfo.isHuPai() ? 1 : 0;
//        }
//    },
